...
const invoicesRepository = require('./src/data/repositories/invoicesRepository')
const filesRepository = require('./src/data/repositories/filesRepository')

filesRepository.initFileInvoices()
console.log(filesRepository.getInvoicesNotFound())

/*invoicesRepository.getInvoices((err, res) => {
  if (err) {
    console.log(err)
  }
  console.log(res)
